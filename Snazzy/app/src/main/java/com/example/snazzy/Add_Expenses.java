        ...
        addExpense.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(memSelected.length()==0 || ExpenseType.length()==0 || Value.length()==0){
                    TastyToast.makeText(com.example.snazzy.Add_Expenses.this,"Please Fill In Valid Data", TastyToast.LENGTH_LONG, TastyToast.CONFUSING);
                    return;
                }
                boolean isInserted = myDb.insertDataTb2(ExpenseType,Value,memSelected.charAt(0)+"");
                if(isInserted)
                    TastyToast.makeText(com.example.snazzy.Add_Expenses.this,"Expense Added", TastyToast.LENGTH_LONG, TastyToast.SUCCESS);
                else
                    TastyToast.makeText(com.example.snazzy.Add_Expenses.this,"Expense Not Added", TastyToast.LENGTH_LONG, TastyToast.ERROR);
            }
        });
    }
