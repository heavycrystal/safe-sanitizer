    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_mem.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(com.example.snazzy.ModifyExpenses.this,R.layout.spinner_layout,R.id.txt,ExpenseList);
            ...
            public void onClick(View v) {
                ...
                if(items==0){
                    ...
                    if(value.length()==0){
                        ...
                        if(isUpdated)
                            TastyToast.makeText(com.example.snazzy.ModifyExpenses.this,"Data Modified", TastyToast.LENGTH_LONG, TastyToast.SUCCESS);
                        else
                            TastyToast.makeText(com.example.snazzy.ModifyExpenses.this,"Data Not Modified", TastyToast.LENGTH_LONG, TastyToast.ERROR);
                        expValue.setText("");
                        expValue.setHint("Current Value: Rs "+value);
                    }
                }
