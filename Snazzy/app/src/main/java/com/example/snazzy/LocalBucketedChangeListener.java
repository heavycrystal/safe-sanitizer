...
public final class LocalBucketedChangeListener implements TextWatcher {
    ...
    public LocalBucketedChangeListener(EditText editText, int expectedContentLength, String
