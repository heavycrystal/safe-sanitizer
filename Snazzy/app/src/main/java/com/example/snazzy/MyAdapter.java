...
public class MyAdapter extends RecyclerView.Adapter<com.example.snazzy.MyAdapter.MyViewHolder>{
    ...
    @NotNull
    @Override
    public com.example.snazzy.MyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
