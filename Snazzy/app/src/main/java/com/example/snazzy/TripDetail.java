    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memberList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TastyToast.makeText(com.example.snazzy.TripDetail.this,""+member, TastyToast.LENGTH_LONG, TastyToast.DEFAULT);
            }
        });
        ...
        endTrip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder a_Builder = new AlertDialog.Builder(com.example.snazzy.TripDetail.this);
                a_Builder.setMessage("Are you sure you want to finish trip and close the app ?").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(isDropped){
                            TastyToast.makeText(com.example.snazzy.TripDetail.this,"Trip Ended Successfully", TastyToast.LENGTH_LONG, TastyToast.SUCCESS);
                            ...
                            TastyToast.makeText(com.example.snazzy.TripDetail.this,"Error in Ending Trip", TastyToast.LENGTH_LONG, TastyToast.ERROR);
                            dialog.cancel();
                        }
                    }
