...
public class MainActivity extends AppCompatActivity {
    ...
    private void setListeners() {
        buttonDate.setOnClickListener(v -> showCalendar());
        buttonTime.setOnClickListener(v -> showClocK());
        ...
        listView.setOnItemClickListener((adapterView, view, position, l) -> showListDialog(position));
    }
