...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table CATEGORIES"+
                        "(username text, category text, image text)"
        );
        db.execSQL(
                "create table ITEMS"+
                        "(username text, category text, item text, price float, quantity integer, image text)"
        );
    }
    @Override
    ...
    public boolean addCategory(String username, String category, String image){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        {
            cv.put(USERNAME, username);
    ...
    //add a getCategpry function
    public boolean editCategory(String username, String newCategory, String newImage, String oldCategory){
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete("CATEGORIES", "username = ? AND category = ?", new String[]{username, oldCategory});
        boolean bool = addCategory(username, newCategory, newImage);
        return bool;
    }
    ...
    public boolean addItem(String username, String category, String item, double price, Integer qty, String imageUri){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        {
            cv.put(USERNAME, username);
    ...
    public boolean editItem(String username, String category, String oldItem, String newItem, double price, Integer qty, String imageUri){
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(ITEMS,"username = ? AND item = ? AND category=?",new String[] { username, oldItem, category });
        boolean bool = addItem(username, category, newItem, price, qty, imageUri);
        return bool;
    }
