    ...
    OnCompleteListener deletion_handler = new OnCompleteListener<Void>() {
        ...
        public void onComplete(@NonNull Task<Void> task) {
            if (task.isSuccessful()) {
                Intent intent = new Intent(RegisterPhase2Activity.this, RegisterPhase1Activity.class);
                ...
                Toast.makeText(RegisterPhase2Activity.this, "Fatal error occured during registration process.", Toast.LENGTH_LONG).show();
            }
        }
    };
